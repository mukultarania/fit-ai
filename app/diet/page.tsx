							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormDescription>
											This helps us tailor your diet plan
											to local foods and preferences.
										</FormDescription>
										<FormMessage />
									</FormItem>
								)}
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormControl>
											<Input
												placeholder="Add any specific food or diet preferences (optional)"
												{...field}
											/>
										</FormControl>
										<FormDescription>
											Let us know if you have any special requests, favorite foods, or preferences.
										</FormDescription>
										<FormMessage />
									</FormItem>
								)}
				...
				<Card className="p-6">
					...
					{!dietPlan ? (
						<div className="h-full flex items-center justify-center text-muted-foreground">
							Fill out the form to generate your personalized diet
							plan
						</div>
					) : (
						<div className="space-y-6">
							<div className="bg-secondary p-4 rounded-lg">
								...
								<p className="text-muted-foreground">
									Calories: {dietPlan.dailyCalories} kcal
								</p>
								<p className="text-muted-foreground">
									Protein: {dietPlan.macronutrients.protein}g
								</p>
								<p className="text-muted-foreground">
									Carbs: {dietPlan.macronutrients.carbs}g
								</p>
								<p className="text-muted-foreground">
									Fats: {dietPlan.macronutrients.fats}g
								</p>
							</div>
							...
							<div className="mt-6 space-y-4">
								<p className="text-muted-foreground">
									Download the PDF for your complete diet plan
									including:
								</p>
