...
export function ResearchSection() {
	return (
		<div className="py-12 px-5 sm:px-8 md:px-16 max-w-screen-lg mx-auto">
			...
			<p className="text-lg text-muted-foreground mb-8">
				...
				scientific research. Below is a curated list of peer-reviewed
				studies spanning several training modalities—from high-intensity
				interval training (HIIT) to resistance training frequency and
				training-to-failure protocols.
			</p>
