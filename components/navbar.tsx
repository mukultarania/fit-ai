		...
		<nav className="fixed top-0 left-0 right-0 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 z-50">
			...
			<div
				className={cn(
					...
					"bg-background/100", // slightly more transparent for stronger blur
					"backdrop-blur-3xl", // maximum blur
					"supports-[backdrop-filter]:bg-background/90" // more transparency for blur
				)}
				style={{ height: isMenuOpen ? "calc(100vh - 4rem)" : 0 }} // 4rem = 64px navbar height
			>
